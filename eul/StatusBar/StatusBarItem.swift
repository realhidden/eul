...
class BaseStatusItem: NSObject {
    ...
    @objc private func forceShowStatusBar() {
        StatusBarManager.shared.forceShowStrip()
    }
    ...
    fileprivate func setupButton() {
        ...
        let showItem = NSMenuItem(title: "Show Status Bar", action: #selector(forceShowStatusBar), keyEquivalent: "")
